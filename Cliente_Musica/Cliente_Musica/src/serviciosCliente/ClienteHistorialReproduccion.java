 ...
 * resource:HistorialreproduccionFacadeREST [modelo.historialreproduccion]<br>
 * USAGE:
 * <pre>
 *        ClienteHistorialReproduccion client = new ClienteHistorialReproduccion();
 ...
 * @author Desktop
 */
public class ClienteHistorialReproduccion {
    ...
    public ClienteHistorialReproduccion() {
        ...
        webTarget = client.target(BASE_URI).path("modelo.historialreproduccion");
    }
    ...
    public List<Cancion> obtenerHistorial(int idUsuario){
        WebTarget resource = webTarget;
