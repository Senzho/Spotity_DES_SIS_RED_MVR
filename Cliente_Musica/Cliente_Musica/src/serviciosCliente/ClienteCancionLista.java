 ...
 * [modelo.cancionlista]<br>
 * USAGE:
 * <pre>
 *        ClienteCancionLista client = new ClienteCancionLista();
 ...
 * @author Desktop
 */
public class ClienteCancionLista {
    ...
    public ClienteCancionLista() {
        ...
        webTarget = client.target(BASE_URI).path("modelo.cancionlista");
    }
    ...
    public void create_JSON(CancionLista cancion) throws ClientErrorException {
        webTarget.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).post(javax.ws.rs.client.Entity.entity(cancion, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    }
